...
def parse_args():
    ...
    parser.add_argument('--save_dir', type=str, default='./test_outputs/sketch')
    parser.add_argument('--img_path', type=str, default='./test_imgs/example_sketch/', help='Image of N sketches.')
    ...
    parser.add_argument('--instance_descriptions', nargs='*', default=["the moon", "the earth"], help='List of N instance descriptions.')
    parser.add_argument('--setting_descriptions', type=str, default='in space', help='Description of the setting.')
    parser.add_argument('--xy', nargs='*', type=lambda s: tuple(map(int, s.split(','))), default=[(100,100), (300,300)], help='List of x,y locations as tuples (x,y).')
    parser.add_argument('--wh', nargs='*', type=lambda s: tuple(map(int, s.split(','))), default=[(250,250), (400,400)], help='List of width,height dimensions as tuples (w,h).')
...
if __name__ == '__main__':
    ...
    n_prompt = 'lowres, cropped, worst quality'  # "Negative Prompt"
    num_samples = 1 # 50
    guess_mode = False
    strength = 1.5
