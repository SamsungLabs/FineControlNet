...
def parse_args():
    ...
    parser.add_argument('--save_dir', type=str, default='./test_outputs/canny')
    parser.add_argument('--img_path', type=str, default='./test_imgs/example_canny/', help='Direcotry to source images or canny edges.')
    ...
    parser.add_argument('--instance_descriptions', nargs='*', default=["a blue sports car", "a white helicopter"], help='List of N instance descriptions.')
    parser.add_argument('--setting_descriptions', type=str, default='at a beach', help='Description of the setting.')
    parser.add_argument('--xy', nargs='*', type=lambda s: tuple(map(int, s.split(','))), default=[(250,300), (50,100)], help='List of x,y locations as tuples (x,y).')
    parser.add_argument('--wh', nargs='*', type=lambda s: tuple(map(int, s.split(','))), default=[(250,120), (270,170)], help='List of width,height dimensions as tuples (w,h).')
