...
def parse_args():
    ...
    parser.add_argument('--save_dir', type=str, default='./test_outputs/openpose')
    parser.add_argument('--img_path', type=str, default='./test_imgs/example_pose/two_people.jpg', help='Direcotry to source image or OpenPose result.')
    ...
    parser.add_argument('--instance_descriptions', nargs='*', default=["spiderman", "darth vader"], help='List of N instance descriptions.')
    parser.add_argument('--setting_descriptions', type=str, default='in the forest', help='Description of the setting.')
...
if __name__ == '__main__':
    ...
    poses, global_detection_map = get_2d_control(input_image, detect_resolution, det)
    ...
    output_path = f'finecontrolnet_annotoverlaid.png'
    output_path = osp.join(save_dir, output_path)
    cv2.imwrite(output_path, output[:, :, ::-1])
